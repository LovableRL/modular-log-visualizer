...
export function TrajectoryTimeline({
  ...
  return (
    <div className="flex h-full min-h-0 flex-col">
      {/* toolbar */}
      <div className="space-y-2 border-b border-border p-3 pr-8">
        <div className="flex flex-wrap items-center gap-1">
          <SubToggle on={showColorBy} onClick={() => setShowColorBy((s) => !s)} label="color-by" />
          <SubToggle on={showKinds} onClick={() => setShowKinds((s) => !s)} label="kinds" />
          <button
            onClick={jumpMaxKL}
